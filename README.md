...
The repository now covers Interim 1 and Interim 2: data analysis, preprocessing,
geolocation integration, feature engineering, model building, model comparison,
...
| Code best practices | Preprocessing, feature engineering, modeling, evaluation, and geolocation are modularized with basic error handling around file loading, type conversion, model scoring, and resampling choices. |
